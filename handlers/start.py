...
async def start_command(message: Message) -> None:
    ...
    text = (
        ...
        "/tasks · /task — задачи\n"
        "/plan · /risk · /sleep — план, риски, сон\n"
        "/collect · /done · /cancel_collect — сбор материалов\n"
        "/study — учебные темы, таймеры, повторение\n"
        "/cost · /diag — расходы и диагностика\n"
        "/pc status — подключённый компьютер\n"
        "/calendar · /research — опциональные интеграции\n"
        "/gtg — быстрые подходы\n"
